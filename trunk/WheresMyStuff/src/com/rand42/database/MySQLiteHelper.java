...
public class MySQLiteHelper extends SQLiteOpenHelper
{
    ...
    private static final String ITEMS_MAKE = "create table "+TABLE_ITEMS+"("+COLUMN_ID
            +" integer primary key autoincrement, "+COLUMN_NAME+" text not null, "+ COLUMN_DESCRIPTION +" text not null, "+COLUMN_CATEGORY+" text not null, "+COLUMN_LOST+" integer not null, "+COLUMN_DATE+" integer not null, "+COLUMN_USER+" integer not null, " +
    ...
    {
        sqLiteDatabase.execSQL(ITEMS_MAKE);
